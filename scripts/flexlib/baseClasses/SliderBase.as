package flexlib.baseClasses
{
   ...
   public class SliderBase extends UIComponent
   {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(directionChanged)
         {
            ...
            if(labelObjects)
            {
               ...
               while(_loc4_ >= 0)
               {
                  (_loc5_ = SliderLabel(labelObjects.getChildAt(_loc4_))).rotation = !!_loc3_?Number(0):Number(90);
                  _loc4_--;
               }
            }
         }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc22_:Number = !(_loc21_ = Number(_loc8_.getExplicitOrMeasuredHeight()))?Number(0):Number(_loc21_ / 2);
      ...
      protected function positionDataTip(param1:Object) : void
      {
         ...
         if(_direction == SliderDirection.HORIZONTAL)
         {
            ...
            if(_loc6_ == "left")
            {
               _loc2_ = _loc2_ - (_loc7_ + mx_internal::dataTip.width);
               _loc3_ = _loc3_ + (param1.height - mx_internal::dataTip.height) / 2;
            }
            ...
            {
               _loc3_ = _loc3_ - (_loc7_ + mx_internal::dataTip.height);
               _loc2_ = _loc2_ - (mx_internal::dataTip.width - param1.width) / 2;
            }
         ...
         else
         {
            ...
            {
               _loc3_ = _loc3_ - (_loc7_ + (mx_internal::dataTip.height + param1.width) / 2);
               _loc2_ = _loc2_ - (mx_internal::dataTip.width - param1.height) / 2;
            }
            else if(_loc6_ == "bottom")
            {
               _loc3_ = _loc3_ + (_loc7_ + (mx_internal::dataTip.height + param1.width) / 2);
         ...
         mx_internal::dataTip.x = _loc9_.x < 0?Number(0):Number(_loc9_.x);
         mx_internal::dataTip.y = _loc9_.y < 0?Number(0):Number(_loc9_.y);
      }
      ...
      private function layoutTicks() : void
      {
         ...
         if(ticks)
         {
            ...
            _loc5_ = (_loc4_ = getStyle("tickThickness")) / 2;
            _loc7_ = getStyle("tickColor");
            _loc8_ = _tickValues && _tickValues.length > 0?true:false;
            _loc9_ = 0;
            _loc10_ = !!_loc8_?Number(_tickValues[_loc9_++]):Number(minimum);
            _loc1_.clear();
            if(_tickInterval > 0 || _loc8_)
            {
               ...
               while((_loc10_ = !!_loc8_?_loc9_ < _tickValues.length?Number(_tickValues[_loc9_++]):Number(NaN):Number(_tickInterval + _loc10_)) < maximum || _loc8_ && _loc9_ < _tickValues.length);
      ...
      override protected function measure() : void
      {
         ...
         var _loc5_:Object;
         var _loc6_:Number = (_loc5_ = getComponentBounds()).lower - _loc5_.upper;
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         {
            if(mx_internal::innerSlider && highlightTrack)
            {
               mx_internal::innerSlider.removeChild(DisplayObject(highlightTrack));
               highlightTrack = null;
            }
